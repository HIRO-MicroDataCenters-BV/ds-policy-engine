...
from app.rest_api.depends import get_rule_management_usecase
...
async def export_rules(
    ...
    """
    from app.rest_api.depends import get_rule_repository
...
async def export_rego():
    ...
    from app.rest_api.depends import get_policy_deployer_usecase
