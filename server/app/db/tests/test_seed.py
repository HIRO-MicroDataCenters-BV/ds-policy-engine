...
class TestSeedFromJson:
    ...
    @pytest.mark.asyncio
    async def test_seeded_rules_are_queryable(
    ...
    @pytest.mark.asyncio
    async def test_seeded_rules_have_correct_ids(
        self, db_session_factory, seed_rules_file
    ):
    ...
    @pytest.mark.asyncio
    async def test_seeded_rules_have_permissions(
        self, db_session_factory, seed_rules_file
    ):
    ...
    @pytest.mark.asyncio
    async def test_returns_zero_for_empty_rules(
        self, db_session_factory, temp_policies_dir
    ):
